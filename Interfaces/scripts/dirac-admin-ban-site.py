#!/usr/bin/env python
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/DIRAC/Interfaces/scripts/dirac-admin-ban-site.py,v 1.1 2008/10/16 09:21:27 paterson Exp $
# File :   dirac-admin-ban-site
# Author : Stuart Paterson
########################################################################
__RCSID__   = "$Id: dirac-admin-ban-site.py,v 1.1 2008/10/16 09:21:27 paterson Exp $"
...
def usage():
  print 'Usage: %s <DIRAC site name> [<DIRAC site name>] --comment="<COMMENT>" [--email=<True/False>]' %(Script.scriptName)

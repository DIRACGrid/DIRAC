#!/usr/bin/env python
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/DIRAC/Interfaces/scripts/dirac-admin-modify-user.py,v 1.1 2008/10/16 09:21:28 paterson Exp $
# File :   dirac-admin-modify-user
# Author : Adrian Casajus
########################################################################
__RCSID__   = "$Id: dirac-admin-modify-user.py,v 1.1 2008/10/16 09:21:28 paterson Exp $"

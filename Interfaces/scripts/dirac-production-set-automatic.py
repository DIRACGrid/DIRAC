#!/usr/bin/env python
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/DIRAC/Interfaces/scripts/dirac-production-set-automatic.py,v 1.1 2008/10/16 09:28:34 paterson Exp $
# File :   dirac-production-set-automatic
# Author : Stuart Paterson
########################################################################
__RCSID__   = "$Id: dirac-production-set-automatic.py,v 1.1 2008/10/16 09:28:34 paterson Exp $"

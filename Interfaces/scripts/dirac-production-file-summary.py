#!/usr/bin/env python
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/DIRAC/Interfaces/scripts/dirac-production-file-summary.py,v 1.1 2008/10/16 09:28:33 paterson Exp $
# File :   dirac-production-file-summary
# Author : Stuart Paterson
########################################################################
__RCSID__   = "$Id: dirac-production-file-summary.py,v 1.1 2008/10/16 09:28:33 paterson Exp $"

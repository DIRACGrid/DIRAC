...
use mysql;
GRANT SELECT,INSERT,LOCK TABLES,UPDATE,DELETE,CREATE,DROP,ALTER ON DatasetDB.* TO 'Dirac'@'localhost' IDENTIFIED BY '';
GRANT SELECT,INSERT,LOCK TABLES,UPDATE,DELETE,CREATE,DROP,ALTER ON DatasetDB.* TO 'Dirac'@'%' IDENTIFIED BY '';

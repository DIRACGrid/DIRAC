  ...
  def __call__( self ):
    ...
    for opFile in waitingFiles:
      ...
      if not registerReplica["OK"] or lfn in registerReplica["Value"]["Failed"]:
        ...
        self.dataLoggingClient().addFileRecord( lfn, "RegisterReplicaFail", ','.join( catalogs ) if catalogs else "", "", "RegisterReplica" )
        ...
        self.dataLoggingClient().addFileRecord( lfn, "RegisterReplicaOK", ','.join( catalogs ) if catalogs else "", "", "RegisterReplica" )

        self.log.info( "Replica %s has been registered at %s" % ( lfn, ','.join( catalogs ) if catalogs else "" ) )
        opFile.Status = "Done"

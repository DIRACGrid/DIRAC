...
def setuptest(request):
    global local_path, putDir, createDir, putFile, isFile, listDir, getDir, getFile, rmDir, removeFile, se, filesInFolderAandB, fileAdlers, fileSizes
    ...
    putDir = {
        ...
        os.path.join(DESTINATION_PATH, "Workflow/FolderB"): os.path.join(local_path, "Workflow/FolderB"),
    }
    ...
    putFile = {
        os.path.join(DESTINATION_PATH, "Workflow/FolderA/File1"): os.path.join(local_path, "Workflow/File1"),
        os.path.join(DESTINATION_PATH, "Workflow/FolderAA/File1"): os.path.join(local_path, "Workflow/File1"),
        os.path.join(DESTINATION_PATH, "Workflow/FolderBB/File2"): os.path.join(local_path, "Workflow/File2"),
        os.path.join(DESTINATION_PATH, "Workflow/FolderB/File2"): os.path.join(local_path, "Workflow/File2"),
        os.path.join(DESTINATION_PATH, "Workflow/File3"): os.path.join(local_path, "Workflow/File3"),
    }
    ...
    for dirName in ("Workflow/FolderA", "Workflow/FolderB"):
        for root, _dirs, files in os.walk(os.path.join(local_path, dirName)):
            for fn in files:
                filesInFolderAandB.append(os.path.join(DESTINATION_PATH, root.replace(local_path, "").strip("/"), fn))

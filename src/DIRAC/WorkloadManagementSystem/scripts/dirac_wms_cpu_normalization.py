...
try:
    from db12 import multiple_dirac_benchmark as multipleDiracBenchmark
except ImportError:
    from DIRAC.WorkloadManagementSystem.Client.DIRACbenchmark import multipleDiracBenchmark

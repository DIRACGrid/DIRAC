...
dict_cs = {
    "Resources": {
        ...
        "StorageElements": {
            ...
            "CERN-WRONGLOCATION-ALIAS": {"Alias": "CERN-BASE-WRONGLOCATION"},
            "CERN-SIMPLE": {
                "BackendType": "Eos",
                "SEType": "T0D1",
...
class StorageFactoryStandaloneTestCase(unittest.TestCase):
    ...
    def test_standalone(self, _sf_generateStorageObject, _rss_getSEStatus):
        ...
        for protocol in ["RemoteAccessProtocol", "LocalAccessProtocol"]:
            ...
            protocolDef.update(fake_gConfig.crawlCS("/Resources/StorageElements/CERN-SIMPLE/%s" % protocol))
        ...
        self.assertListEqual(
            sorted(allProtocols, key=lambda x: x["Host"]), sorted(storages["ProtocolOptions"], key=lambda x: x["Host"])
        )
...
class StorageFactorySimpleInheritance(unittest.TestCase):
    ...
    def test_simple_inheritance_overwrite(self, _sf_generateStorageObject, _rss_getSEStatus):
        ...
        self.assertDictEqual(
            ...
            {"BackendType": "Eos", "SEType": "T0D1", "PledgedSpace": 205, "BaseSE": "CERN-BASE"},
        )
    ...
    def test_simple_inheritance(self, _sf_generateStorageObject, _rss_getSEStatus):
        ...
        self.assertDictEqual(
            storages["StorageOptions"], {"BackendType": "Eos", "SEType": "T0D1", "BaseSE": "CERN-BASE"}
        )

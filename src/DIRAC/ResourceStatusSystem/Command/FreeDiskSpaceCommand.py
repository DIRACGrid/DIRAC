...
class FreeDiskSpaceCommand(Command):
    ...
    def doNew(self, masterParams=None):
        ...
        if masterParams is not None:
            ...
            banned_threshold = self.args.get("Banned_threshold")
            degraded_threshold = self.args.get("Degraded_threshold")
            banned_fraction = self.args.get("Banned_fraction")
            degraded_fraction = self.args.get("Degraded_fraction")
        else:

...
class SystemLoggingReportHandler(RequestHandler):
    ...
    def __getMessages(self, selectionDict={}, sortList=[], startItem=0, maxItems=0):
        """ """
        ...
        retValue = {"ParameterNames": fieldList, "Records": records, "TotalRecords": len(result["Value"]), "Extras": {}}
    ...
    def export_getSystems(self, selectionDict={}, sortList=[], startItem=0, maxItems=0):
    ...
    def export_getSubSystems(self, selectionDict={}, sortList=[], startItem=0, maxItems=0):
    ...
    def export_getGroups(self, selectionDict={}, sortList=[], startItem=0, maxItems=0):
    ...
    def export_getFixedTextStrings(self, selectionDict={}, sortList=[], startItem=0, maxItems=0):
        ...
        retValue = {
            "ParameterNames": ["FixedTextString"],
            "Records": records,
            "TotalRecords": len(result["Value"]),
            "Extras": {},
        }

...
class LoggerClient:
    ...
    def getMessagesByFixedText(self, texts, beginDate=None, endDate=None, startRecord=0, maxRecords=100):
        """Query the database for all messages whose fixed part match 'texts'
        that were generated between beginDate and endDate
        """
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"FixedTextString": texts, "beginDate": beginDate, "endDate": endDate}, [], startRecord, maxRecords
        )

    def getMessagesBySystem(self, system, beginDate=None, endDate=None, startRecord=0, maxRecords=100):
        """Query the database for all messages generated by system(s) 'system'
        that were generated between beginDate and endDate
        """
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"SystemName": system, "beginDate": beginDate, "endDate": endDate}, [], startRecord, maxRecords
        )

    def getMessagesBySite(self, site, beginDate=None, endDate=None, startRecord=0, maxRecords=100):
        """Query the database for all messages generated by 'site' that were
        generated between beginDate and endDate
        """
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"SiteName": site, "beginDate": beginDate, "endDate": endDate}, [], startRecord, maxRecords
        )

    def getMessagesByUser(self, userDN, beginDate=None, endDate=None, startRecord=0, maxRecords=100):
        """Query the database for all messages generated by the user: 'userDN'
        that were generated between beginDate and endDate
        """
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"OwnerDN": userDN, "beginDate": beginDate, "endDate": endDate}, [], startRecord, maxRecords
        )

    def getMessagesByGroup(self, group, beginDate=None, endDate=None, startRecord=0, maxRecords=100):
        """Query the database for all messages generated by the group 'Group'
        that were generated between beginDate and endDate
        """
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"OwnerGroup": group, "beginDate": beginDate, "endDate": endDate}, [], startRecord, maxRecords
        )

    def getMessagesBySiteNode(self, node, beginDate=None, endDate=None, startRecord=0, maxRecords=100):
        """Query the database for all messages generated at 'node' that were
        generated between beginDate and endDate
        """
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"ClientFQDN": node, "beginDate": beginDate, "endDate": endDate}, [], startRecord, maxRecords
        )
    ...
    def getCountMessages(self, conds={}, beginDate=None, endDate=None, startRecord=0, maxRecords=100):

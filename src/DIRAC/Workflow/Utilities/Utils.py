    ...
    for moduleName in modulesNameList:
        ...
        try:
            ...
            moduleDef.setDescription(
                getattr(__import__("%s.%s" % (importLine, moduleName), globals(), locals(), ["__doc__"]), "__doc__")
            )
            ...
            moduleDef.setDescription(
                getattr(
                    __import__("%s.%s" % (alternativeImportLine, moduleName), globals(), locals(), ["__doc__"]),
                    "__doc__",
                )
            )
...
def getStepCPUTimes(step_commons):
    ...
    if "StartStats" in step_commons:
        ...
        cputimeBefore = (
            step_commons["StartStats"][0]
            + step_commons["StartStats"][1]
            + step_commons["StartStats"][2]
            + step_commons["StartStats"][3]
        )

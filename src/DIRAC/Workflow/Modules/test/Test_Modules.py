...
class ModulesTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.rm_mock = Mock()
        self.rm_mock.getReplicas.return_value = {
            "OK": True,
            "Value": {"Successful": {"pippo": "metadataPippo"}, "Failed": None},
        }
        self.rm_mock.getCatalogFileMetadata.return_value = {
            "OK": True,
            "Value": {"Successful": {"pippo": "metadataPippo"}, "Failed": None},
        }
        ...
        self.step_commons = [
            {
                ...
                "listoutput": [
                    {
                        "outputDataName": str(self.prod_id) + "_" + str(self.prod_job_id) + "_",
                        "outputDataSE": "aaa",
                        "outputDataType": "bbb",
                    }
                ],
...
class ModuleBaseSuccess(ModulesTestCase):
    ...
    def test_getCandidateFiles(self):
        ...
        outputList = [
            {"outputDataType": "txt", "outputDataSE": "Tier1-RDST", "outputDataName": "foo_1.txt"},
    ...
    def test__determineStepInputData(self):
        ...
        inputData = "previousStep"
        self.mb.appSteps = ["Brunel_1", "DaVinci_2"]
        self.mb.workflow_commons["outputList"] = [
            {
                "stepName": "Brunel_1",
                "outputDataType": "brunelhist",
                "outputBKType": "BRUNELHIST",

...
class GOCDBClient:
    ...
    def getStatus(self, granularity, name=None, startDate=None, startingInHours=None, timeout=None):
        """
        ...
        if startingInHours is not None:
            ...
            if resXML_ongoing is None:
                ...
                resOngoing = self._downTimeXMLParsing(resXML_ongoing, granularity, name)
            ...
            if resXML_startDate is None:
                ...
                resStartDate = self._downTimeXMLParsing(resXML_startDate, granularity, name, startDateMax)
    ...
    def getServiceEndpointInfo(self, granularity, entity):
        ...
        try:
            ...
            _msg = f"Exception getting information for {granularity} {entity}: {e}"
    ...
    def _downTimeXMLParsing(self, dt, siteOrRes, entities=None, startDateMax=None):
        ...
        for dtElement in downtimeElements:
            ...
            try:
                ...
                try:
                    ...
                    dtDict[
                        str(dtElement.getAttributeNode("PRIMARY_KEY").nodeValue) + " " + elements["SITENAME"]
                    ] = elements
        ...
        if startDateMax is not None:
            for dtID in list(dtDict):
                startDateMaxFromKeys = datetime(
                    *time.strptime(dtDict[dtID]["FORMATED_START_DATE"], "%Y-%m-%d %H:%M")[0:5]
                )

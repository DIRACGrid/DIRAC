...
class TestDRA(unittest.TestCase):
  ...
  def test_checkJob_others(self):
    ...
    self.assertEqual(self.dra.todo['InputFiles'][0]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][1]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][2]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][3]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][4]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 0)
    ...
    self.assertIn("setJobFailed", tInfoMock.method_calls[0])
    self.assertEqual(self.dra.todo['InputFiles'][0]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][1]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][2]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][3]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][4]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][0]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][1]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][2]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][3]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][4]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][1]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][2]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][3]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][4]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][2]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][3]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][4]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][3]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][4]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 0)
  ...
  def test_checkAllJob(self):
    ...
    self.assertEqual(self.dra.todo['InputFiles'][4]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][5]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][6]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][7]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][8]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 0)
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][9]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 0)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][10]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 1)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][11]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][13]['Counter'], 1)
    ...
    self.assertEqual(self.dra.todo['InputFiles'][12]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][13]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][14]['Counter'], 1)
    self.assertEqual(self.dra.todo['InputFiles'][-1]['Counter'], 0)

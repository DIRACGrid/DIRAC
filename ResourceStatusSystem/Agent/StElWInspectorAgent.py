...
AGENT_NAME = 'ResourceStatus/StElWInspectorAgent'

class StElWInspectorAgent(AgentModule):
...
#############################################################################
  ...
  def initialize(self):
    ...
    try:
      ...
      errorStr = "StElWInspectorAgent initialization"
...
#############################################################################
  ...
  def execute(self):
    ...
    try:
      ...
      res = self.rsDB.getStuffToCheck('StorageElementsWrite', self.StorageElements_check_freq) 
  ...
  def _executeCheck(self, arg):
    ...
    while True:
      ...
      try:
        ...
        gLogger.exception('StElWInspector._executeCheck')
        try:

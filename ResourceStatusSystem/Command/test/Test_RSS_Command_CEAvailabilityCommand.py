...
class CEAvailabilityCommand_Success( CEAvailabilityCommand_TestCase ):
  ...
  def test_doCommand( self ):
    ...
    self.DAObjectMock.getBDIICEState.return_value = {'OK': True,
                                                    'Value': [{'GlueCEInfoLRMSType': 'torque',
                                                               'GlueCEInfoDataDir': 'unset',
                                                               'GlueCEInfoTotalCPUs': '928',
                                                               'GlueCEImplementationName': 'CREAM',
                                                               'GlueCEInfoJobManager': 'pbs',
                                                               'GlueCEUniqueID': 'cygnus.grid.rug.nl:8443/cream-pbs-short',
                                                               'GlueCEPolicyMaxCPUTime': '240', 'GlueCEStateTotalJobs': '20',
                                                               ...
                                                               'dn': 'GlueCEUniqueID=cygnus.grid.rug.nl:8443/cream-pbs-short,Mds-Vo-name=RUG-CIT,Mds-Vo-name=local,o=grid',
                                                               ...
                                                               'GlueCEAccessControlBaseRule': ['VO:ops', 'VO:dteam', 'VO:pvier',
                                                                                               'VO:ops.biggrid.nl', 'VO:lhcb', 'VO:biomed',
                                                                                               'VO:astron', 'VO:bbmri.nl', 'VO:chem.biggrid.nl',
                                                                                               'VO:dans', 'VO:drihm.eu', 'VO:esr',
                                                                                               'VO:euclid-ec.org', 'VO:ildg', 'VO:lofar',
                                                                                               'VO:lsgrid', 'VO:omegac', 'VO:projects.nl',
                                                                                               'VO:tutor', 'VO:vlemed', 'VO:vo.panda.gsi.de'],
                                                               'GlueCEPolicyMaxSlotsPerJob': '2147483647',
                                                               'GlueCEPolicyPreemption': '0',
                                                               'GlueCECapability': ['CPUScalingReferenceSI00=2421', 'glexec'],
                                                               'GlueSchemaVersionMajor': '1',
                                                               'GlueCEPolicyAssignedJobSlots': '928',
                                                               'GlueCEHostingCluster': 'cygnus.grid.rug.nl'
                                                              },
                                                              {'GlueCEInfoLRMSType': 'torque',
                                                               'GlueCEInfoDataDir': 'unset', 'GlueCEInfoTotalCPUs': '928',
                                                               'GlueCEImplementationName': 'CREAM',
                                                               'GlueCEInfoJobManager': 'pbs',
                                                               'GlueCEUniqueID': 'cygnus.grid.rug.nl:8443/cream-pbs-medium',
                                                               ...
                                                               'GlueCEInfoApplicationDir': '/vo-software',
                                                               'dn': 'GlueCEUniqueID=cygnus.grid.rug.nl:8443/cream-pbs-medium,Mds-Vo-name=RUG-CIT,Mds-Vo-name=local,o=grid',
                                                               'GlueCEInfoLRMSVersion': '2.5.13',
                                                               'GlueCEPolicyMaxWaitingJobs': '2147483647',
                                                               ...
                                                               'GlueCEAccessControlBaseRule': ['VO:ops', 'VO:dteam', 'VO:pvier',
                                                                                               'VO:ops.biggrid.nl', 'VO:lhcb', 'VO:biomed',
                                                                                               'VO:astron', 'VO:bbmri.nl',
                                                                                               'VO:chem.biggrid.nl', 'VO:dans',
                                                                                               'VO:drihm.eu',
                                                                                               'VO:esr', 'VO:euclid-ec.org',
                                                                                               'VO:ildg', 'VO:lofar', 'VO:lsgrid',
                                                                                               'VO:omegac',
                                                                                               'VO:projects.nl', 'VO:tutor', 'VO:vlemed',
                                                                                               'VO:vo.panda.gsi.de'],
                                                               'GlueCEPolicyMaxSlotsPerJob': '2147483647', 'GlueCEPolicyPreemption': '0',
                                                               'GlueCECapability': ['CPUScalingReferenceSI00=2421', 'glexec'],
                                                               'GlueSchemaVersionMajor': '1',
                                                               'GlueCEPolicyAssignedJobSlots': '928',
                                                               'GlueCEHostingCluster': 'cygnus.grid.rug.nl'
    ...
    self.DAObjectMock.getBDIICEState.return_value = {'OK': True,
                                                     'Value': [{'GlueCEInfoLRMSType': 'torque',
                                                                ...
                                                                'GlueCEPolicyMaxTotalJobs': '2147483647',
                                                                'GlueCEAccessControlBaseRule': ['VO:ops', 'VO:dteam', 'VO:pvier',
                                                                                                'VO:ops.biggrid.nl', 'VO:lhcb',
                                                                                                'VO:biomed', 'VO:astron', 'VO:bbmri.nl',
                                                                                                'VO:chem.biggrid.nl', 'VO:dans',
                                                                                                'VO:drihm.eu', 'VO:esr', 'VO:euclid-ec.org',
                                                                                                'VO:ildg', 'VO:lofar', 'VO:lsgrid',
                                                                                                'VO:omegac', 'VO:projects.nl', 'VO:tutor',
                                                                                                'VO:vlemed', 'VO:vo.panda.gsi.de'],
                                                                'GlueCEPolicyMaxSlotsPerJob': '2147483647',
                                                                'GlueCEPolicyPreemption': '0',
                                                                'GlueCECapability': ['CPUScalingReferenceSI00=2421', 'glexec'],
                                                                'GlueSchemaVersionMajor': '1',
                                                                'GlueCEPolicyAssignedJobSlots': '928', 'GlueCEHostingCluster': 'cygnus.grid.rug.nl'
                                                               },
                                                               {'GlueCEInfoLRMSType': 'torque',
                                                                'GlueCEInfoDataDir': 'unset', 'GlueCEInfoTotalCPUs': '928',
                                                                'GlueCEImplementationName': 'CREAM',
                                                                ...
                                                                'GlueCEPolicyPriority': '2147483647',
                                                                'GlueCEPolicyMaxTotalJobs': '2147483647',
                                                                'GlueCEAccessControlBaseRule': ['VO:ops', 'VO:dteam', 'VO:pvier', 'VO:ops.biggrid.nl', 'VO:lhcb', 'VO:biomed', 'VO:astron', 'VO:bbmri.nl', 'VO:chem.biggrid.nl', 'VO:dans', 'VO:drihm.eu', 'VO:esr', 'VO:euclid-ec.org', 'VO:ildg', 'VO:lofar', 'VO:lsgrid', 'VO:omegac', 'VO:projects.nl', 'VO:tutor', 'VO:vlemed', 'VO:vo.panda.gsi.de'],
                                                                'GlueCEPolicyMaxSlotsPerJob': '2147483647', 'GlueCEPolicyPreemption': '0', 'GlueCECapability': ['CPUScalingReferenceSI00=2421', 'glexec'],
                                                                'GlueSchemaVersionMajor': '1',
                                                                'GlueCEPolicyAssignedJobSlots': '928',
                                                                'GlueCEHostingCluster': 'cygnus.grid.rug.nl'
                                                  }]

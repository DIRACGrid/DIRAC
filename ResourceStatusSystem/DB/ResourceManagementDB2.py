...
class ResourceManagementDB2( object ):

  # Written PrimaryKey as list on purpose !!
  __tables = {}
  __tables[ 'AccountingCache' ] = { 'Fields' : 
                      {
  ...
  __tables[ 'PolicyResultLog' ] = { 'Fields' : 
                      {
  ...
  __tables[ 'SpaceTokenOccupancyCache' ] = { 'Fields' :
                      {
  ...
  __tables[ 'UserRegistryCache' ] = { 'Fields' : 
                      {
                       'Login' : 'VARCHAR(16)',
                       'Name'  : 'VARCHAR(64) NOT NULL',

...
#
#    if resQuery[ 'Value' ]:
#      self.__updateSiteRow( siteName, siteType, gridSiteName )
#
#    else:
#      self.__addSiteRow( siteName, siteType, gridSiteName )
#      # We set the new status as Banned by default
#      self.setSiteStatus( siteName, '', 'Banned', '')
#
##    if resQuery[ 'Value' ]:
...
##      else:
##        oldStatus = 'Active'
##      self._addSiteHistoryRow( siteName, statusType, oldStatus, reason, 
##                               dateCreated, dateEffective,
##                               datetime.datetime.utcnow().replace( microsecond = 0 ).isoformat( ' ' ),
##                               tokenOwner )
##
##    #in any case add a row to present Sites table
##    self._addSiteRow( siteName, siteType, gridSiteName, statusType, status, 
...
#
#    self.addOrModifySite( siteName, siteType, gridSiteName, statusType, status, 
...
#
#    req = "INSERT INTO SitesHistory (SiteName, StatusType, Status, Reason, DateCreated,"

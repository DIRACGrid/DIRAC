...
class DowntimeCache(rmsBase):
  ...
  def fromDict( self, dictionary ):
    ...
    self.downtimeID = dictionary.get( 'DowntimeID', self.name )
    self.name = dictionary.get( 'Name', self.name )
    self.element = dictionary.get( 'Element', self.name )
    self.gocDBServiceType = dictionary.get( 'GOCDBServiceType', self.name )
    self.severity = dictionary.get( 'Severity', self.name )
    self.description = dictionary.get( 'Description', self.name )
    self.link = dictionary.get( 'Link', self.name )
    self.startDate = dictionary.get( 'StartDate', self.name )
    self.endDate = dictionary.get( 'EndDate', self.name )
    self.dateEffective = dictionary.get( 'DateEffective', self.dateEffective )
    self.lastCheckTime = dictionary.get( 'LastCheckTime', self.lastCheckTime )

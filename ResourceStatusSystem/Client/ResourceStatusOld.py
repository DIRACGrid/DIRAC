...
#################################################################################
#
#  def __getRSSStorageElementStatus( self, elementName, statusType, defaultStatus ):
#    '''
#    Gets from RSS the StorageElements status. If there is an error of it returns
#    empty, it returns defaultStatus - if given.
#    '''
#
#    meta = { 'columns' : [ 'Name', 'StatusType', 'Status' ] }   
#    res  = self.rssClient.selectStatusElement( 'Resource', 'Status', name = elementName, 
#                                               statusType = statusType, meta = meta )
...
#        statusType = ''
#
#      defList = [ [ el, statusType, defaultStatus ] for el in elementName ]
...
#        res = gConfig.getOption( "%s/%s/%sAccess" % ( cs_path, element, statusType ), 'Active' )
#        if res[ 'OK' ] and res[ 'Value' ]:
...
#################################################################################
#
#def getDictFromList( listToProcess ):
#  '''
...
#
#  res = {}
#  for listItem in listToProcess:
#    site, sType, status = listItem

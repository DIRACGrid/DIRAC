...
class ResourceStatusClient( object ):
  ...
  def insertStatusElement( self, element, tableType, name, statusType, status,
    ...
    :return: S_OK() || S_ERROR()
    '''
    return self.rssService.insert( element + tableType, self._prepare(locals()) )
  ...
  def selectStatusElement( self, element, tableType, name = None, statusType = None,
    ...
    :return: S_OK() || S_ERROR()
    '''
    return self.rssService.select( element + tableType, self._prepare(locals()) )
  ...
  def deleteStatusElement( self, element, tableType, name = None, statusType = None,
    ...
    return self.rssService.delete( element + tableType, self._prepare(locals()) )
  ...
  def addOrModifyStatusElement( self, element, tableType, name = None,
    ...
    :return: S_OK() || S_ERROR()
    '''
    return self.rssService.addOrModify( element + tableType, self._prepare(locals()) )
  ...
  def addIfNotThereStatusElement( self, element, tableType, name = None,
    ...
    :return: S_OK() || S_ERROR()
    '''
    return self.rssService.addIfNotThere( element + tableType, self._prepare(locals()) )

########################################################################
# $Id: gLiteAgentMonitor.py,v 1.1 2008/01/15 13:26:19 paterson Exp $
...
__RCSID__ = "$Id: gLiteAgentMonitor.py,v 1.1 2008/01/15 13:26:19 paterson Exp $"
...
class gLiteAgentMonitor(AgentMonitor):
  ...
  def __init__(self):
    ...
    self.cmd = 'glite-wms-job-status'
    self.cmdTimeout = 60
    AgentMonitor.__init__(self,'GLITE')
  ...
  def getPilotStatus(self,jobID,pilotID):
    ...
    timing = '>>> GLITE WMS status query time %.2fs' % queryTime

...
"""
__RCSID__ = "2a2b8c6 (2012-04-23 01:05:17 -0700) Andrei Tsaregorodtsev <atsareg@gmail.com>"
...
if cliParams.boincHostPlatform:
  configureOpts.append( '-o /LocalSite/Platfrom=%s' % cliParams.boincHostPlatform)
if cliParams.boincHostName:
  configureOpts.append( '-o /LocalSite/Hostname=%s' % cliParams.boincHostName )

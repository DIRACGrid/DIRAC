...
##############################################################################################################################
# $Id: JobWrapperTemplate.py,v 1.26 2009/05/20 22:26:16 rgracian Exp $
...
from DIRAC                                                  import S_OK, S_ERROR, gConfig, gLogger, systemCall
...
def execute ( arguments ):
  ...
  os.environ['DCACHE_RAHEAD'] = 1
  os.environ['DCACHE_RA_BUFFER'] = 50 * 1024

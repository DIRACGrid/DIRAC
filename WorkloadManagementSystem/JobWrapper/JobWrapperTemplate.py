...
##############################################################################################################################
# $Id: JobWrapperTemplate.py,v 1.7 2009/03/12 14:06:40 paterson Exp $
...
def rescheduleFailedJob(jobID,message):
    ...
    jobReport.setJobStatus('Failed','ReschedulingJob', sendFlag = True )
...
def execute ( arguments ):
  ...
  try:
    ...
    #TODO finish tidying here so %s can be used and treat exceptions properly

...
AGENTS = [('DIRAC.AccountingSystem.Agent.NetworkAgent', {'IgnoreOptions': ['MaxCycles', 'MessageQueueURI',
          ...
          ('DIRAC.ResourceStatusSystem.Agent.ElementInspectorAgent', {'IgnoreOptions': ['elementType',
                                                                                        'maxNumberOfThreads',
                                                                                        'limitQueueFeeder']}),
          ('DIRAC.ResourceStatusSystem.Agent.EmailAgent', {'IgnoreOptions': ['Status']}),
          ('DIRAC.ResourceStatusSystem.Agent.SiteInspectorAgent', {'IgnoreOptions': ['elementType',
                                                                                     'maxNumberOfThreads',
                                                                                     'limitQueueFeeder']}),
          ('DIRAC.ResourceStatusSystem.Agent.SummarizeLogsAgent', {}),
          ('DIRAC.ResourceStatusSystem.Agent.TokenAgent', {'IgnoreOptions': ['notifyHours', 'adminMail']}),

...
#############################################################################
def getSitesGroupedByTierLevel(gridName='', siteName=''):
  """
...
#############################################################################
def getTier1WithAttachedTier2(gridName='', siteName=''):
  ...
  """
  tier1andTier2Maps = {}
  tiers = getSitesGroupedByTierLevel(gridName, siteName)
  if not tiers['OK']:
    return tiers
...
#############################################################################
def getTier1WithTier2(gridName='', siteName=''):
  """

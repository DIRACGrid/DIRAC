...
from DIRAC.ConfigurationSystem.Client.Helpers.Registry       import getDefaultUserGroup, getVOForGroup
...
from DIRAC.ConfigurationSystem.Client.Helpers.Registry       import getDNForUsername, getUserOption

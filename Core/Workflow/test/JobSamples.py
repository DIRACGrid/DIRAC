...
module3.appendParameter(Parameter("outputDataSE","","string","self","outputDataSE",True,False,"SE of output data"))
...
module5.appendParameter(Parameter("outputDataSE","","string","self","outputDataSE",True,False,"SE of output data"))
...
module6.appendParameter(Parameter("outputDataSE","","string","self","outputDataSE",True,False,"SE of output data"))
module6.appendParameter(Parameter("outputData",'',"string","self","outputData",True,False,"list of output data"))
module6.appendParameter(Parameter("poolXMLCatName","","string","self","poolXMLCatName",True,False,"POOL XML slice"))
module6.appendParameter(Parameter("inputData","","string","self","inputData",True,False,"InputData"))
module6.appendParameter(Parameter("appType","","string","self","appType",True,False,"Application Version"))
...
step1.appendParameter(Parameter("outputData","@{STEP_ID}.root","string","","",True,False,"etc name"))
step1.appendParameter(Parameter("outputDataSE","Tier1-RDST","string","","",True,False,"etc name"))
step1.appendParameter(Parameter("etcf","SETC_@{STEP_ID}.root","string","","",True,False,"etc name"))

...
from DIRAC.Core.HTTP.Core.TemplateLoader import TemplateLoader
...
class App(object):
  ...
  def bootstrap(self):
    ...
    # Configure tornado app      .append(('/request_uri', <class 'WebAppDIRAC.Lib.Callback'>))
    # routes.append(('/request_uri', <class 'WebAppDIRAC.Lib.Callback'>))

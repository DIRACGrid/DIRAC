    ...
    def testComponent(self):
        ...
        if not service1Present:
            result = self.monitoringClient.getInstallations(
                {"Instance": "Notification", "UnInstallationTime": None, "InstalledBy": self.user},
                {"DIRACSystem": "Framework", "Type": "service", "DIRACModule": "Notification"},
                {},
                False,
            )
        else:
            ...
            result = self.monitoringClient.getInstallations(
                {"Instance": "Notification", "UnInstallationTime": None},
                {"DIRACSystem": "Framework", "Type": "service", "DIRACModule": "Notification"},
                {},
                False,
            )

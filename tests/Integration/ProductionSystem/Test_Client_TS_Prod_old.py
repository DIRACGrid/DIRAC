...
class ProductionClientChain(TestClientProductionTestCase):
  ...
  def test_addTransformationsToProduction(self):
    ...
    outputquery = MetaQuery({'zenith': {'in': [20, 40]}, 'particle': 'gamma',
                             'tel_sim_prog': 'simtel', 'outputType': {'in': ['Data', 'Log']}})
    ...
    res = self.transClient.addTransformation(
        ...
        outputMetaData=json.dumps(outputmetadata))
    ...
    outputquery = MetaQuery({'particle': 'gamma', 'analysis_prog': {
                            'in': ['evndisp', 'mars']}, 'outputType': {'in': ['Data', 'Log']}})
  ...
  def test_SeqProduction(self):
    ...
    inputquery = MetaQuery({'zenith': 20, 'particle': 'gamma', 'tel_sim_prog': 'simtel', 'outputType': 'Data'})
    outputquery = MetaQuery({'zenith': 20, 'particle': 'gamma', 'analysis_prog': 'evndisp',
                             'data_level': 1, 'outputType': {'in': ['Data', 'Log']}})
    ...
    inputquery = MetaQuery({'zenith': 20,
                            'particle': 'gamma',
                            'analysis_prog': 'evndisp',
                            'data_level': 1,
                            'outputType': 'Data'})
    outputquery = MetaQuery({'zenith': 20, 'particle': 'gamma', 'analysis_prog': 'evndisp',
                             'data_level': 2, 'outputType': {'in': ['Data', 'Log']}})
  ...
  def test_SplitProduction(self):
    ...
    outputquery = MetaQuery({'zenith': 40, 'particle': 'gamma', 'analysis_prog': 'mars',
                             'data_level': 1, 'outputType': {'in': ['Data', 'Log']}})
    ...
    res = self.prodClient.addTransformationsToProduction(
        prodID, [analysis_step1a_transID, analysis_step1b_transID], MCtransID)
    self.assertTrue(res['OK'])
  ...
  def test_MergeProduction(self):
    ...
    # Create a MCSimulation transformation with an output meta query and output metadata
    outputquery = MetaQuery({'zenith': 20, 'particle': 'gamma', 'tel_sim_prog': 'simtel',
                             'outputType': {'in': ['Data', 'Log']}})
    outputquery = outputquery.getMetaQueryAsJson()
    # Not used in the Production validation for the moment
    outputmetadata = {'particle': 'gamma', 'tel_sim_prog': 'simtel', 'outputType': 'Data'}
    ...
    outputquery = MetaQuery({'zenith': 40, 'particle': 'gamma', 'tel_sim_prog': 'simtel',
                             'outputType': {'in': ['Data', 'Log']}})
    outputquery = outputquery.getMetaQueryAsJson()
    # Not used in the Production validation for the moment
    outputmetadata = {'particle': 'gamma', 'tel_sim_prog': 'simtel', 'outputType': 'Data'}
    ...
    # Create the Analysis_step1 transformation
    inputquery = MetaQuery({'zenith': {'in': [20, 40]}, 'particle': 'gamma',
                            'tel_sim_prog': 'simtel', 'outputType': 'Data'})
    outputquery = MetaQuery({'zenith': {'in': [20, 40]}, 'particle': 'gamma',
                             'analysis_prog': 'evndisp', 'data_level': 1, 'outputType': {'in': ['Data', 'Log']}})

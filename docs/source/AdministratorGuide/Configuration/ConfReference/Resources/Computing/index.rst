...
This section is used to define a compatibility matrix between dirac platforms (:ref:`_admin_dirac-platform`) and OS versions.
...
What's on the left is an example of a dirac platform as determined the dirac-platform script (:ref:`_admin_dirac-platform`). 
